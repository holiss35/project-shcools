...
(function(){
	...
	function opacityUlFlash(num,newNum,oldNum){//num表示递归的起始值；newNum表示当前位置；oldNum表示之前位置
		...
		if(num<=100)
		{
			...
			return setTimeout(function(){opacityUlFlash(num,newNum,oldNum);},20);
		}
...
(function(){
	...
	window.onscroll=function(){
		var scrollH=document.documentElement.scrollTop+document.body.scrollTop;/*document.documentElement.scrollTop支持IE及ff；+document.body.scrollTop支持chrome\opera等*/
